...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference("Anime.count") do
      post animes_url, params: { anime: { ano: @anime.ano, categoria: @anime.categoria, episodios: @anime.episodios, nome: @anime.nome } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { ano: @anime.ano, categoria: @anime.categoria, episodios: @anime.episodios, nome: @anime.nome } }
